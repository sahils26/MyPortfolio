...
export default function Now(currentlyReading) {
  ...
  var SahilBirthDate = '2003-01-26'
  var birthDate = new Date(SahilBirthDate)

  var SahilAge = year - birthDate.getFullYear()

  var SahilMonth = 0
  if (month >= birthDate.getMonth()) SahilMonth = month - birthDate.getMonth()
  else {
    SahilAge--
    SahilMonth = 12 + month - birthDate.getMonth()
  }

  var SahilDay = 0
  if (date >= birthDate.getDate()) SahilDay = date - birthDate.getDate()
  else {
    SahilMonth--
    SahilDay = 31 + date - birthDate.getDate()
    if (SahilMonth < 0) {
      SahilMonth = 11
      SahilAge--
    }
